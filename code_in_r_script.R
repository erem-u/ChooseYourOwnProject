...
# It is stored in the Prognostics Data Repository hosted by NASA (https://ti.arc.nasa.gov/tech/dash/groups/pcoe/prognostic-data-repository/#turbofan)
...
# The folder that contains the files with vibration analysis data is stored in Github and has also been uploaded to Edx.
